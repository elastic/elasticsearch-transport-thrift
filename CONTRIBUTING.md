...
**Repository:** [https://github.com/elasticsearch/elasticsearch-transport-thrift](https://github.com/elasticsearch/elasticsearch-transport-thrift)
...
```sh
cd elasticsearch-transport-thrift/
