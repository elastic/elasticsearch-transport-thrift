...
public class RestRequest implements org.apache.thrift.TBase<RestRequest, RestRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RestRequest> {
  ...
  static {
    ...
    schemes.put(TupleScheme.class, new RestRequestTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.PARAMETERS,_Fields.HEADERS,_Fields.BODY};
...
;
  ...
  private static class RestRequestStandardSchemeFactory implements SchemeFactory {
    public RestRequestStandardScheme getScheme() {
      return new RestRequestStandardScheme();
    }
  }

  private static class RestRequestStandardScheme extends StandardScheme<RestRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RestRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i5 = 0; _i5 < _map4.size; ++_i5)
                {
                  ...
                  struct.headers.put(_key6, _val7);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RestRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.parameters != null) {
        if (struct.isSetParameters()) {
          oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter8 : struct.parameters.entrySet())
            {
  ...
  private static class RestRequestTupleSchemeFactory implements SchemeFactory {
    public RestRequestTupleScheme getScheme() {
      return new RestRequestTupleScheme();
    }
  }

  private static class RestRequestTupleScheme extends TupleScheme<RestRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RestRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (Map.Entry<String, String> _iter10 : struct.parameters.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.parameters = new HashMap<String,String>(2*_map12.size);
          for (int _i13 = 0; _i13 < _map12.size; ++_i13)
          {
            ...
            struct.parameters.put(_key14, _val15);
          }
        }
        struct.setParametersIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          for (int _i17 = 0; _i17 < _map16.size; ++_i17)
          {
            ...
            struct.headers.put(_key18, _val19);
          }
        }
        struct.setHeadersIsSet(true);
      }
